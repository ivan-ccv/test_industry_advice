export const formOneData = [
...

  {
    ...
    questionValueOne: "usersName",
    questionValueTwo: "usersCompanyName",
...
export const formTwoData = [
  {
    step: 0,
    question: "What industry are you in?",
    questionValue: "whatIndustryAreYouIn",
    answers: ["Food & Drink", "Retail", "Services", "Other"],
    answersValues: ["Food & Drink", "Retail", "Services", "Other"],
    imagesValues: [
      "https://chameleon-assets.mvfglobal.com/images/icons/64a802751933146893110f591bd51451.svg",
      "https://chameleon-assets.mvfglobal.com/images/icons/81fbf788dcf1d06ae981c63d702200c4.svg",
      "https://chameleon-assets.mvfglobal.com/images/icons/9c3c3686d7fe24eb4699b36df47019da.svg",
      "https://chameleon-assets.mvfglobal.com/images/icons/17e43ed0d2767ece326babe5439c5d81.svg",
    ],
  ...
  },
  {
    ...
    questionValue: "whichBestDescribesYourCompany",
    answers: [
  ...
  },
  {
    step: 2,
    type: "radio",
    question: "How many terminals do you require?",
    questionValue: "howManyTerminals",
    answers: ["1", "2", "3-5", "Over 5"],
    answersValues: ["1", "2", "3-5", "Over 5"],
  },
  {
    step: 3,
    type: "radio",
    question: "When do you need your new POS system?",
    questionValue: "whenDoYouNeedSystem",
    answers: ["ASAP", "1-3 Months", "4-6 Months"],
    answersValues: ["ASAP", "1-3 Months", "4-6 Months"],
  },
  {
    type: "radio",
    question: "Are you also interested in credit card processing?",
    questionValue: "interestedInCreditCardProcessing",
    answers: ["Yes", "No"],
    answersValues: ["Yes", "No"],
  },
  {
    step: 4,
    questionValue: "usersZIP",
  ...
  },
  {
    step: 6,
    type: "radio",
    question: "Would you be interested in a free demo?",
    questionValue: "interestedInFreeDemo",
    answers: ["Yes", "No", "Maybe"],
    answersValues: ["Yes", "No", "Maybe"],
  },
  {
    step: 7,
    questionValue: "usersEmail",
...

  {
    ...
    question: "Thank you for submitting form, we will contact you soon!",
    // src: endImage,
    src: "../assets/glass.gif",
  },
];

export const formThreeData = [
  {
    step: 0,
    question: "What industry are you in? (pick one)",
    questionValue: "whatIndustryAreYouIn",
    answers: ["Food & Drink", "Retail", "Services", "Other"],
    answersValues: ["Food & Drink", "Retail", "Services", "Other"],
    imagesValues: [
  ...
  {
    step: 1,
    question: "What industry are you in? (you can pick more than one)",
    questionValue: "whatIndustryAreYouIn",
    answers: ["Food & Drink", "Retail", "Services", "Other"],
    answersValues: ["Food & Drink", "Retail", "Services", "Other"],
    imagesValues: [
  ...
  {
    step: 2,
    question: "Do you have a system to collect data?",
    questionValue: "doYouHaveTimeAndAttendanceSystem",
